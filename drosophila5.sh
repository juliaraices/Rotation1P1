...
# scaffoldsassembly
srun --cpu_bind=verbose SOAPdenovo-Trans-31mer all -s drosophila_soap.txt -K 31 -o drosophila_assembly -p 16 # run all binaries with srun (srun will have a list of CPUs which were allocated to your job)
