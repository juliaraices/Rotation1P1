...
srun --cpu_bind=verbose cat Dmel_Ccap_onlyhits.BLAST | cut -f 1,2,4 | awk '{print $1, $2, $3}' | sort >Dmel_Ccap.BLAST.clean
...
# final synteny table:
srun --cpu_bind=verbose cat Dmel_Ccap_onlyhits.BLAST | awk '{print $2,$1}' | sort >Dmel_Ccap.BLAST.sorted2
