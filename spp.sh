...
#zgrep ^"4932\." protein.links.full.v10.5.txt.gz | awk '($10 != 0) {print $1, $2, $10}' > scerevisiae_experimental.txt
zgrep ^"4932\." protein.aliases.v10.5.txt.gz > scerevisiae_aliases.txt
